...
def main():
  ...
  automata0.states.append(temp_node)
  temp_node= State(4)
  temp_transition = Transition('0', 6)
  temp_node.transitions.append(temp_transition)
  temp_transition = Transition('1', 6)
  temp_node.transitions.append(temp_transition)
  temp_transition = Transition('2', 6)
  temp_node.transitions.append(temp_transition)
  temp_transition = Transition('3', 6)
  temp_node.transitions.append(temp_transition)
  temp_transition = Transition('4', 6)
  temp_node.transitions.append(temp_transition)
  temp_transition = Transition('5', 6)
  temp_node.transitions.append(temp_transition)
  temp_transition = Transition('6', 6)
  temp_node.transitions.append(temp_transition)
  temp_transition = Transition('7', 6)
  temp_node.transitions.append(temp_transition)
  temp_transition = Transition('8', 6)
  temp_node.transitions.append(temp_transition)
  temp_transition = Transition('9', 6)
  temp_node.transitions.append(temp_transition)
  automata0.states.append(temp_node)
  temp_node= State(5)
  temp_transition = Transition('A', 5)
